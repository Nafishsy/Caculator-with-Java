...
public class FrameIntro  extends JFrame implements ActionListener
{
	...
	JButton btn7,btn8,btn9,btn6,btn5,btn4,btn3,btn2,btn1,btn0,btnAdd,btnMul,btnEq,btnClr,btnDed,btnDiv,btnDot,btnC;
	...
	public FrameIntro()
	{
		...
		btn0 = new JButton("0");
		btn0.setBounds(80, 280, 50, 50);
		btn0.addActionListener(this);
		panel.add(btn0);
		
		btnDot = new JButton(".");
		btnDot.setBounds(140, 280, 50, 50);
		...
		btnDed = new JButton("-");
		btnDed.setBounds(200, 220, 50, 50);
		...
		btnEq = new JButton("=");
		btnEq.setBounds(200, 340, 50, 50);
		btnEq.addActionListener(this);
		panel.add(btnEq);
		
		
		btnClr = new JButton("AC");
		btnClr.setBounds(140, 340, 50, 50);
		btnClr.addActionListener(this);
		panel.add(btnClr);
		
		
		btnC = new JButton("C");
		btnC.setBounds(80, 340, 50, 50);
	 ...
	 public void actionPerformed(ActionEvent ae)
	{
		...
		else if(btnC.getText().equals(command)){
			resultTextField.setText("");
		}
